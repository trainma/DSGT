import util.node2vec.node2vec as node2vec
import numpy as np
...
window_size = 10
iter = 1000
Adj_file = './data/BeiJingAir/Station_pois.txt'
SE_file = './data/BeiJingAir/poi_embed.txt'


def read_graph(edgelist):
    return nx.read_edgelist(edgelist, nodetype=int, data=(('weight', float),), create_using=nx.DiGraph())
